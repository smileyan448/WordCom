...
5. Read the top 20 words with largest PageRank centrality by ProPre.exe in the PreProcess folder as follows.
    ProPre filename K 1
...
7. Read the top 20 words with largest PageRank centrality by ProPre.exe in the PreProcess folder as follows.
    ProPre filename K 1
    where K is the number of clusters, 1 means read top words.
...
3. The experimental results of WordCom on seven testing corpora (Title, Tweet, Tweet_10, Tset, Tset_50, SMS, Q&A) are included in the results folder.
